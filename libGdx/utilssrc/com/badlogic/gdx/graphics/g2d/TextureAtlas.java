...
public class TextureAtlas implements Disposable {
	...
	public static class TextureAtlasData {
		...
		public TextureAtlasData(Array<Page> pages,Array<Region> regions){
	...
	public AtlasRegion findRegion (String name) {
		...
		NLog.e(name+" is null ! You are a fool ??");
		return null;
	}
	...
	static public class AtlasRegion extends TextureRegion {
		...
		/** The ninepatch splits, or null if not a ninepatch. Has 4 elements: left, carRun, top, bottom. */
		public int[] splits;

		/** The ninepatch pads, or null if not a ninepatch or the has no padding. Has 4 elements: left, carRun, top, bottom. */
		public int[] pads;
