...
public class Texture extends GLTexture {
    ...
    public void load(TextureData data) {
        ...
        if (isDebug) Gdx.app.log("Texture", "loaded");
    }
     ...
     * draw only inside the texture region. Note that this will only draw to mipmap level1 0!
     *
    ...
    public void dispose() {
        ...
        delete();
        if (data.isManaged()) if (managedTextures.get(Gdx.app) != null)
