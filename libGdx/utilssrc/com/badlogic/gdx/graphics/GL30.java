...
// *indices )
	...
	// C function void glTexImage3D ( GLenum target, GLint level1, GLint internalformat, GLsizei width, GLsizei height, GLsizei
...
// depth, GLint border, GLenum format, GLenum type, GLsizei offset )
	...
	// C function void glTexSubImage3D ( GLenum target, GLint level1, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width,
...
// GLsizei height, GLsizei depth, GLenum format, GLenum type, GLsizei offset )
	...
	// C function void glCopyTexSubImage3D ( GLenum target, GLint level1, GLint xoffset, GLint yoffset, GLint zoffset, GLint x,
// GLint y, GLsizei width, GLsizei height )

	public void glCopyTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int x, int y, int width,
                                    int height);

// // C function void glCompressedTexImage3D ( GLenum target, GLint level1, GLenum internalformat, GLsizei width, GLsizei height,
...
// );
//
// // C function void glCompressedTexSubImage3D ( GLenum target, GLint level1, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei
...
// GLsizei height )
	...
	// C function void glFramebufferTextureLayer ( GLenum target, GLenum attachment, GLuint texture, GLint level1, GLint layer )
