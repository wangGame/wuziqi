...
public class Actor {
     ...
     * (0,0 is the bottom left of the actor and width,height is the upper carRun).
     * <p>
     ...
     * transform matrix and the stage's phyWorldCamera must not have rotational components. Calling this method must be followed by a call
